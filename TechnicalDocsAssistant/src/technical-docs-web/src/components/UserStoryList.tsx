                ...
                <div className="space-y-4">
                    {userStories.length === 0 ? (
                        ...
                        userStories.map((story) => (
                            <div
                                key={story.id}
                                className={`relative p-4 border rounded-lg cursor-pointer transition-all hover:border-indigo-300 ${
                            ...
                            >
                                ...
                                <div className="absolute top-4 right-4 flex items-center gap-2">
                                    ...
                                    {showDeleteConfirm === story.id ? (
                                        <div className="absolute right-0 top-10 bg-white shadow-lg rounded-lg p-3 border z-10">
                                            <p className="text-sm mb-3 text-gray-700">Delete this story?</p>
